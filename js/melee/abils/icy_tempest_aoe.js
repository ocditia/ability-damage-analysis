...
function icy_tempest_main(type, settings, numberOfHits) {
    ...
    for(var hitsplat = 0; hitsplat < numberOfHits; hitsplat++) {
        ...
        onHit[0] = Math.floor(onHit[0] * (1 + settings['primordial ice']/10));
        onHit[1] = Math.floor(onHit[1] * (1 + settings['primordial ice']/10));
...
export default icy_tempest_main;
