...
function rapid_fire_necro(a, b) {
	...
	settings = next_tick(settingss);
	damage += hit_damage_calculation(settingss);
	settings = next_tick(settingss);
	damage += hit_damage_calculation(settingss);
	settings = next_tick(settingss);
	damage += hit_damage_calculation(settingss);
...
export default rapid_fire_necro;
