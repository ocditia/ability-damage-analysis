...
function necro_auto_tx(type, settings, numberOfHits) {
	...
	for (var hitsplat = 0; hitsplat < numberOfHits; hitsplat++) {
		...
		let fixed = Math.floor(AD * fixedPercent) * 2;
		let variable = Math.floor(AD * variablePercent) * 2;
