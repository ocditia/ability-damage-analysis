...
function finger_of_death_ld(type, settings, numberOfHits) {
	...
	for (var hitsplat = 0; hitsplat < numberOfHits; hitsplat++) {
		...
		let fixed = Math.floor(Math.floor(AD * fixedPercent) * 1.5);
		let variable = Math.floor(Math.floor(AD * variablePercent) * 1.5);
...
export default finger_of_death_ld;
