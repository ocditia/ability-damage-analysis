...
function greater_sonic_wave_beta(type, settings, numberOfHits) {
	...
	let abil_val = 'greater sonic wave beta';
	...
	for (var hitsplat = 0; hitsplat < numberOfHits; hitsplat++) {
		...
		hits.push(
			AVG_INS.returnDecider(damageObject, settings, abil_val, concStacks, channellerStacks)
		);
	}
...
export default greater_sonic_wave_beta;
