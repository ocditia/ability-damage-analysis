                    ...
                    <a href="/melee" class="flex flex-col group">
                        <div class="card border-b border-card-light">
                            ...
                            >
                                ...
                                <div class="card-title">Melee Damage Calculator (partly updated)</div>
                            </div>
                        </div>
                    </a>
                    <a href="/ranged" class="flex flex-col group">
                        <div class="card border-b border-card-light">
                            ...
                            >
                                ...
                                <div class="card-title">Ranged Damage Calculator (partly updated)</div>
                            </div>
                        </div>
                    </a>
                    <a href="/necromancy" class="flex flex-col group">
                        <div class="card border-b border-card-light">
                            ...
                            >
                                ...
                                <div class="card-title">Necromancy Damage Calculator (partly updated)</div>
                            </div>
                        </div>
                    </a>
                    <a href="/rotation_builder" class="flex flex-col group">
                        <div class="card">
                            ...
                            >
                                ...
                                <div class="card-title">Rotation Builder (unfinished)</div>
                            </div>
                        </div>
                    </a>
                </div>
