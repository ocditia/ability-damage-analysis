...
<Navbar />
<Header img="{base}/magic_background.png" text="Magic Calculator" icon="{base}/style_icons/magic-white.svg" />
				...
				<form class="w-full">
					<div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-8">
						...
						<div class="md:col-span-1">
							...
							<Number
									setting={settings[SETTINGS.ESSENCE_CORRUPTION]}
							...
							<div class="md:col-span-1">
								...
								/>
								<Number
									setting={settings[SETTINGS.MAGIC_LEVEL]}
									on:settingsUpdated={updateDamages}
									step="1"
									max="150"
									min="1"
							...
							<div class="md:col-span-1">
								...
								/>
								<Number
									setting={settings[SETTINGS.FLOW_STACKS]}
									on:settingsUpdated={updateDamages}
									step="1"
									max="100"
									min="0"
							...
							<div class="md:col-span-1">
								...
								<Checkbox
									setting={settings[SETTINGS.CONFLAGRATE]}
									on:settingsUpdated={updateDamages}
								/>
								<Select setting={settings[SETTINGS.KERAPACS_WRIST_WRAPS]} on:settingsUpdated={updateDamages} />
								<Checkbox
									setting={settings[SETTINGS.WALKED_TARGET]}
									on:settingsUpdated={updateDamages}
								/>
								<Number
									setting={settings[SETTINGS.CONCENTRATED_BLAST_STACKS]}
									on:settingsUpdated={updateDamages}
									step="1"
									max="3"
									min="0"
							...
							<div class="md:col-span-1">
								...
								<Select
									setting={settings[SETTINGS.MAGIC_PRAYER]}
									on:settingsUpdated={updateDamages}
